...
export class QRGenerator {
  ...
  async generateSVG(data, options = {}) {
    ...
    const qrStylingOptions = {
      ...
      qrOptions: {
        errorCorrectionLevel:
          options.eccLevel || styling.QR_OPTIONS.ERROR_CORRECTION,
        mode: 'Byte',
      },
      imageOptions: {
    ...
    try {
      ...
      this.utils.debug(
        'Styled QR generation failed, falling back to basic',
        error
      );
      ...
      const qrOptions = {
        ...
        errorCorrectionLevel:
          options.eccLevel || this.config.QR.ERROR_CORRECTION,
      };
      ...
      return {
        ...
        data,
        options: qrOptions,
        capacity: this.utils.checkQRCapacity(
          data,
  ...
  parseSVGString(svgString) {
    ...
    // Extract dimensions
    const width =
      parseInt(svgElement.getAttribute('width')) || this.config.QR.SIZE_PX;
    const height =
      parseInt(svgElement.getAttribute('height')) || this.config.QR.SIZE_PX;
